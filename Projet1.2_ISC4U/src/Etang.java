...
public class Etang { //classe de l'étang
		private int NombrePoisson; 
		private Poisson [] TabPoisson;

	public Etang(int capacitemax) {//fixé une capacité maximale à l'étang
	...
	public boolean estSature() {//vérifie si l'étang est saturé
		boolean sat;
		int compteur = 0;
	...
	public void Ajoutter(Poisson p) {//ajoutter un poisson dans l'étang (tableau)
	...
	public void ListePoisson() {//lister les poissons dans l'étang (tableau)
